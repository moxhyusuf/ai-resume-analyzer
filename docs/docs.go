...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/resume.AnalyzeResponse"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "resume.AnalysisResult": {
            ...
            "properties": {
                ...
                "sections": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/resume.Section"
                    }
                },
                "suggestions": {
                    "type": "array",
        ...
        "resume.AnalyzeResponse": {
            "type": "object",
            "properties": {
                "analysis": {
                    "$ref": "#/definitions/resume.AnalysisResult"
                },
                "resume_id": {
                    "type": "string"
                }
